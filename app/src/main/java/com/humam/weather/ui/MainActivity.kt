...
import com.humam.weather.BuildConfig
import com.humam.weather.R
import com.humam.weather.data.response.ForecastWeatherResponse
import com.humam.weather.data.response.ListItem
import com.humam.weather.data.response.WeatherResponse
import com.humam.weather.databinding.ActivityMainBinding
import com.humam.weather.utils.HelperFunctions.formatDegree
import com.humam.weather.utils.LOCATION_PERMISSION_REQ_CODE
import com.humam.weather.utils.iconSizeWeather4x
import java.util.*
    ...
    private fun setupView(weather: WeatherResponse?, forecast: ForecastWeatherResponse?) {
        ...
        forecast?.list.let {
            binding.rvWeather.apply {
                weatherAdapter.setData(it as List<ListItem>?)
